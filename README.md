...
```
# basic code:
findGenome --group "group" --outfolder "outfolder" --genome_type "chloroplast" --batch_size 50 --duplicate_removal --max_individuals INT --overwrite
...
options:
  ...
  --collapse_to_species Collapse multiple accessions per species to the best Average Nucleotide Identity (ANI)
                        or Mash Distance hit.
